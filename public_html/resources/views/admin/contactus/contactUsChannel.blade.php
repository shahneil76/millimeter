    ...
    <div class="subheader py-2 py-lg-4  subheader-solid " id="kt_subheader">
        <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <form action="{{ route('admin.channel.export') }}" method="POST">
                    @csrf
                    <a href="#" class="btn btn-sm btn-light font-weight-bold kt-margin-l-20" id="filter_daterange"
                        ...
                        <span class="text-muted font-size-base font-weight-bold mr-2" id="filter_daterange_title">Today</span>
                        <span class="text-primary font-size-base font-weight-bolder" id="filter_daterange_date">Aug
                            16</span>
                            <input type="hidden" name="start_date" id="start_date">
                            <input type="hidden" name="end_date" id="end_date">
                    </a>
                    <button class="btn btn-primary btn-sm kt-margin-l-20"><i class="flaticon-download mr-2"></i>Export</button>
                </form>
            </div>
            <!--end::Info-->
    ...
    <script>
        $(function() {
            ...
            var dtable = $('#table').DataTable({
                ...
                ajax: {
                    "url" : "{{ route('admin.contactus.channel') }}",
                    "data" : function(d){
                ...
                columns: [{
                    ...
                    {
                        data: 'channel_designation',
                        name: 'channel_designation'
                    },
                    {
                        data: 'channel_phoneno',
                        name: 'channel_phoneno'
                    },
                    {
                        data: 'channel_email',
                        name: 'channel_email'
